...
github:     https://github.com/tsupinie/vad-plotter
"""
...
class VADFile(object):
    ...
    def _get_data(self):
        ...
        r_e = 4. / 3. * 6371
        data['altitude'] = np.sqrt(r_e ** 2 + data['slant_range'] ** 2 + 2 * r_e * data['slant_range'] * np.sin(
            np.radians(data['elev_angle']))) - r_e
